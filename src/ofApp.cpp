...
//Note that comments have been left in from the original example.
...
void ofApp::setup(){
	...
	ofSetWindowTitle("Joni's Gui Mash");
	...
	gui.setup();
	gui.add(circleResolution.setup("Circle Resolution", 5, 3, 90));
	gui.add(blackCircle.setup("Black Circle"));
}
